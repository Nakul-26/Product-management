            ...
            <div className="card">
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                <div>
                  ...
                  <p style={{ margin: '0.5rem 0 0', fontSize: '1.5rem', fontWeight: 800, color: data.lowStock > 0 ? 'var(--color-danger)' : 'inherit' }}>{data.lowStock}</p>
                </div>
                <div style={{ background: data.lowStock > 0 ? '#fef2f2' : '#f0fdf4', padding: '0.5rem', borderRadius: '8px', color: data.lowStock > 0 ? 'var(--color-danger)' : 'var(--color-success)' }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="card">
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                <div>
                  ...
                  <p style={{ margin: '0.5rem 0 0', fontSize: '1.5rem', fontWeight: 800 }}>₹ {data.pendingPaymentsAmount.toFixed(2)}</p>
                </div>
              ...
              <table>
                ...
                <tbody>
                  {profit.topProfitableProducts.length === 0 ? (
                    <tr><td colSpan={5} className="muted" style={{ textAlign: 'center', padding: '2rem' }}>No profit data yet.</td></tr>
                  ) : (
